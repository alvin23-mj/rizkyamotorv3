    ...
    <>
      ...
      {moreDrawerOpen && (
        <>
          ...
          <div className="fixed bottom-[68px] right-2 sm:right-16 z-50 w-52 sm:w-56 bg-white border border-slate-200 shadow-2xl py-1 text-xs text-slate-800 animate-in fade-in zoom-in-95 duration-100 rounded-md">
            <Link
              href="/schedule"
              onClick={() => setMoreDrawerOpen(false)}
              className="px-4 py-2.5 text-slate-700 hover:bg-slate-100 hover:text-slate-900 font-semibold flex items-center gap-2.5"
            >
            ...
            <a
              ...
              onClick={() => setMoreDrawerOpen(false)}
              className="px-4 py-2.5 text-orange-600 hover:bg-orange-50 font-bold flex items-center gap-2.5 border-t border-slate-100"
            >
            ...
            {session && (
              <button
                ...
                className="w-full text-left px-4 py-2.5 text-rose-600 hover:bg-rose-50 font-bold flex items-center gap-2.5 border-t border-slate-100 cursor-pointer"
              >
