      ...
      >
        {(brands.length > 0
          ...
          <Link
            ...
            className="w-38 sm:w-44 shrink-0 snap-start bg-white py-5 px-4 rounded-md border-0 shadow-md hover:shadow-lg hover:-translate-y-1.5 transition-all duration-200 flex flex-col items-center justify-center text-center cursor-pointer"
          >
